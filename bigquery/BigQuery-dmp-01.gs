...
var CONFIG = {
    BIGQUERY_PROJECT_ID: 'kacarobacvar-150116',
    BIGQUERY_DATASET_ID: 'bq_test_05',
    ...
    DEFAULT_DATE_RANGE: '20190101,20190731',
    ...
    FIELDS: {'Cost' : 'FLOAT',
            ...
            'CurrentModelAttributedConversionValue' : 'FLOAT',
            'CrossDeviceConversions' : 'FLOAT',
            'ClickAssistedConversions' : 'INTEGER',
            'ClickAssistedConversionsOverLastClickConversions' : 'INTEGER',
            'CampaignName' : 'STRING',
            'AdGroupName' : 'STRING',
            'Id' : 'INTEGER',
            'AdGroupId' : 'INTEGER',
    ...
    CONDITIONS: '',
    FIELDS:{'CountryCriteriaId' : 'STRING',
            'IsTargetingLocation' : 'STRING',
            'LocationType' : 'STRING',
            'MostSpecificCriteriaId' : 'STRING',
    ...
    CONDITIONS: '',
    FIELDS:{'CallDuration' : 'STRING',
            'CallStartTime' : 'STRING',
            'CallEndTime' : 'STRING',
            'CallerCountryCallingCode' : 'STRING',
            'CallStatus' : 'STRING',
            'CallType' : 'STRING',
            'CampaignId' : 'STRING',
            'CampaignName' : 'STRING',
